...
import { Button, Input, Textarea } from "@/core/libs";
          ...
          <form onSubmit={handleSubmitEvent} className="space-y-4 w-full">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="flex flex-col w-full">
                <label className="text-white text-sm mb-1">Waktu Mulai</label>
                <Input
                  type="datetime-local"
              ...
              <div className="flex flex-col w-full">
                <label className="text-white text-sm mb-1">Waktu Selesai</label>
                <Input
                  type="datetime-local"
