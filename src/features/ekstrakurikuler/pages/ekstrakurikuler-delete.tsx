...
export const EkstrakurikulerDelete = () => {
  ...
  return (
    <DashboardPageLayout
      siteTitle={`${lang.text("deleteEkstrakurikuler")} ${decodeParams?.text} | ${APP_CONFIG.appName}`}
      breadcrumbs={[
        {
        ...
        {
          label: lang.text("deleteEkstrakurikuler"),
          url: `/ekstrakurikuler/delete/${params.id}`,
        },
      ]}
      title={lang.text("deleteEkstrakurikuler")}
    >
      <Vokadialog
