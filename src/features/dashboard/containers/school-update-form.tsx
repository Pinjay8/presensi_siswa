...
export const SchoolUpdateForm = ({ onClose }: SchoolUpdateFormProps) => {
  ...
  const SchoolID: number | undefined = profile.user?.sekolahId ?? 0;
  const school: any = useSchoolDetail({ id: SchoolID });
  ...
  return (
    <FormProvider {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="mb-8">
        ...
        <div className="flex flex-col justify-between sm:flex-row gap-10 mb-2">
                  ...
                  <FormItem>
                    ...
                    >
                      <FormControl>
                        ...
                        >
                          <SelectValue
                            placeholder={lang.text("selectStatus")}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
        ...
        <div className="flex flex-col sm:flex-row gap-10 mb-2">
          <div className="basis-1 sm:basis-1/3">
            <FormField
              control={form.control}
              name="provinceId"
                  ...
                  <FormItem>
                    ...
                    <Select value={field.value} onValueChange={field.onChange}>
                      <FormControl>
                        ...
                        >
                          <SelectValue
                            placeholder={lang.text("selectProvince")}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
