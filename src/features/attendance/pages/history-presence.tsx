...
import { fetchBiodataApi, fetchClassesApi, generateQrCodeApi } from "../utils";
...
export function HistoryAttendance() {
  ...
  const fetchClasses = useCallback(async () => {
    try {
      ...
      if (!classes || classes.length === 0) {
        setError("Data kelas tidak tersedia. Silakan coba lagi nanti.");
        setClassOptions([]);
      } else {
  ...
  return (
    <div className="container mx-auto h-screen p-4 relative">
      ...
      <div className="mt-6">  
        <div className="relative">
          <div
            className="p-2 border rounded-md text-gray-200 bg-gray-700 dark:bg-gray-800 w-48 flex justify-between items-center cursor-pointer"
            onClick={() => setDropdownOpen(!dropdownOpen)}
          >
            <span>{selectedClass || "Semua Kelas"}</span>
