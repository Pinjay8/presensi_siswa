...
const StudentLetterPDF: React.FC<{
  ...
  console.log('testt bukaaaaa::::', schoolData?.pembukaan);
  console.log('testt isiiiiii::::', schoolData?.pernyataanLulus);
  console.log('testt tutupppp::::', schoolData?.penutupan);
...
export const GraduationLandingTables = () => {
      ...
      const doc = (
        <StudentLetterPDF
          ...
          schoolData={{
            namaSekolah: school?.data?.namaSekolah || 'Nama Sekolah',
            kopSurat: school.data?.kopSurat || '',
            judulSurat: school.data?.judulSurat || 'Surat Keterangan Lulus',
            namaKepalaSekolah: school.data?.namaKepalaSekolah || 'Nama Kepala Sekolah',
            ttdKepalaSekolah: school.data?.ttdKepalaSekolah,
            pembukaan: letterText.pembukaan,
            pernyataanLulus: letterText.pernyataanLulus,
  ...
  return (
    <>
      ...
      <GraduationTable
        data={graduations.isLoading || school.isLoading ? [] : graduationData}
