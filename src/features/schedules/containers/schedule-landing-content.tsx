...
//   jamMulai: string;
//   jamSelesai: string;
//   mataPelajaran: { id: number; namaMataPelajaran: string };
...
//   // Restore focus to course search input after searchCourse updates
//   useEffect(() => {
//     if (searchInputRef.current) {
//       const activeElement = document.activeElement;
//       console.log('Course Search Active Element:', activeElement?.tagName, activeElement?.className);
//       if (activeElement !== searchInputRef.current) {
//         console.log('Restoring focus to course search input');
//         searchInputRef.current.focus();
//       }
//     }
//   }, [searchCourse]);

//   // Restore focus to teacher search input after searchTeacher updates
//   useEffect(() => {
//     if (teacherSearchInputRef.current) {
//       const activeElement = document.activeElement;
//       console.log('Teacher Search Active Element:', activeElement?.tagName, activeElement?.className);
//       if (activeElement !== teacherSearchInputRef.current) {
//         console.log('Restoring focus to teacher search input');
...
//     return teachers?.data?.filter((teacher: any) =>
//       teacher.namaGuru.toLowerCase().includes(searchTeacher.toLowerCase())
//     ) || [];
//   }, [teachers?.data, searchTeacher]);

//   // Handle keydown to prevent focus shift to dropdown options
...
//     acc[day] = schedules?.data[day] || [];
//     return acc;
//   }, {} as Record<string, ScheduleItem[]>);

//   // Sort schedules by jamMulai for each day
...
//     const payload = { ...formData, hari: selectedDay };
//     console.log('Data to be sent:', payload);

//     try {
//       await creation.create({ ...formData, hari: selectedDay });
//       alert.success(
//         lang.text("successful", {
//           context: lang.text("scheduleSuccessCreate", {
//             context: "",
//           }),
//         })
//       );
...
//         err?.message ||
//           lang.text("failed", {
//             context: lang.text("scheduleFailCreate", {
//               context: "",
//             }),
//           })
//       );
...
//     try {
//       await creation.update(editScheduleId, { ...formData, hari: selectedDay });
//       alert.success(
//         lang.text("successful", {
//           context: lang.text("scheduleSuccessUpdate", {
//             context: "",
//           }),
//         })
//       );
...
//         err?.message ||
//           lang.text("failed", {
//             context: lang.text("scheduleFailUpdate", {
//               context: "",
//             }),
//           })
//       );
...
//         <DialogContent>
//           <DialogHeader>
//             <DialogTitle>Tambah Jadwal - {selectedDay}</DialogTitle>
//           </DialogHeader>
...
// import { useRef, useState, useEffect, useMemo } from "react";
// import { useScheduleCreation, useSchedules } from "../hooks";
// import { CircleSlashIcon, Pen, School, School2, Trash } from "lucide-react";
...
//     return (
//       classes?.filter((kelas: any) =>
//         kelas.namaKelas.toLowerCase().includes(searchClass.toLowerCase())
//       ) || []
//     );
//   }, [classes, searchClass]);
...
//   // Debug groupedByClassAndDay
//   console.log("groupedByClassAndDay", groupedByClassAndDay);
...
//   // Restore focus to class search input
//   useEffect(() => {
//     if (classSearchInputRef.current && document.activeElement !== classSearchInputRef.current) {
...
//     try {
//       await creation.update(editScheduleId, { ...formData });
//       alert.success(
//         lang.text("successful", {
...
//   const openAddModal = (day: string, kelasId: number) => {
//     setSelectedDay(day);
//     setFormData({ ...formData, hari: day, kelasId });
//     setSearchCourse("");
//     setSearchTeacher("");
//     setSearchClass("");
//     setIsAddModalOpen(true);
...
//               <Select
//                 onValueChange={(value) =>
//                   setFormData({ ...formData, kelasId: parseInt(value) })
//                 }
//               >
//                 <SelectTrigger>
...
//                   </div>
//                   {filteredCourses
//                     .filter((course: any) => course.kelasId === formData.kelasId || !formData.kelasId)
//                     .map((course: any) => (
//                       <SelectItem key={course.id} value={course.id.toString()}>
//                         {course.namaMataPelajaran}
//                       </SelectItem>
...
//               <label htmlFor="kelasId">Kelas</label>
//               <Select
//                 value={formData.kelasId.toString()}
//                 onValueChange={(value) =>
//                   setFormData({ ...formData, kelasId: parseInt(value) })
//                 }
//               >
...
//       <div className="grid gap-8 mt-5 mb-8">
//         {Object.keys(groupedByClassAndDay).length > 0 ? (
//           Object.keys(groupedByClassAndDay).map((kelasId) => {
...
//                   <School2 /> Kelas: {classes.find((k: any) => k.id === parseInt(kelasId))?.namaKelas || `Kelas ${kelasId}`}
//                 </h1>
...
//                       )}
//                       <div className="border-t border-white/10 pt-4">
//                         <Button onClick={() => openAddModal(day, parseInt(kelasId))}>
//                           Tambah Jadwal
//                         </Button>
//                       </div>
//                     </div>
...
//           })
//         ) : (
//           <p className="text-gray-500 text-center">Tidak ada jadwal tersedia.</p>
//         )}
//       </div>
//     </>
//   );
